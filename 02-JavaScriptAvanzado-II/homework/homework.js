...
function cacheFunction(cacheGuardado) {
  /*
  Ejercicio 2
  ...
  */
  let cacheAlmacenado = {};
  return function (arg) {
    if (cacheAlmacenado.hasOwnProperty(arg)) {
      console.log(cacheAlmacenado)
      return cacheAlmacenado[arg];
    } else {
      cacheAlmacenado[arg] = cacheGuardado(arg)
      return cacheAlmacenado[arg];
    }
  }
}

function cacheGuardado(arg) {
   return arg;
}

const squareCache = cacheFunction(cacheGuardado)
console.log(squareCache("youtube"))
console.log(squareCache("youtube"))
